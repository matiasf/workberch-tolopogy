...
public class DynamicWorkberchTopologyMain {
	...
	public static void main(final String[] args) throws ReaderException, IOException {
		...
		if (StringUtils.isNotEmpty(WorkberchConstants.GUID) && StringUtils.isNotEmpty(WorkberchConstants.WORKFLOW_PATH) && StringUtils.isNotEmpty(WorkberchConstants.OUTPUT_PATH) && StringUtils.isNotEmpty(WorkberchConstants.INDEX_FIELD)) {

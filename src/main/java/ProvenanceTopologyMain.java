...
//
//public class ProvenanceTopologyMain {
//	
...
//		
//		final List<String> dummyFields = new ArrayList<String>();
//		dummyFields.add("number");
//		
//		builder.setBolt("tavernaDummyBolt", new WorkberchTavernaProcessorBolt(dummyFields) {
//		
//			private static final long serialVersionUID = 1L;
//
//			@Override
//			public void executeTavernaLogic(final WorkberchTuple input, final BasicOutputCollector collector, final boolean lastValues) {
...
//			}
//			
//		}).shuffleGrouping("tavernaDummyBolt");
//
